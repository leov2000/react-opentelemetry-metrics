        ...
        <div>
          ...
          {lastCustomEvent.time !== "None" && (
            <div className="custom-event-container">
              ...
              <p>
                Time:{" "}
                <span className="event-detail">{lastCustomEvent.time}</span>
              </p>
              <p>
                Details:{" "}
                <span className="event-detail">{lastCustomEvent.details}</span>
              </p>
              <p>
                Count:{" "}
                <span className="event-detail">{metrics.customEvents}</span>
              </p>
            </div>
          )}
        </div>
